...
contract DexTest is Test {
    ...
    function testAddLiquidity5() external {
        ...
        console.log(tokenX.allowance(address(tokenX), sender));
    ...
    function testRemoveLiquidity1() external {
        uint firstLPReturn = dex.addLiquidity(1000 ether, 1000 ether, 0); //1000
        emit log_named_uint("firstLPReturn", firstLPReturn); //1000 ether

        uint secondLPReturn = dex.addLiquidity(1000 ether * 2, 1000 ether * 2, 0); //2000
        emit log_named_uint("secondLPReturn", secondLPReturn);
